...
| **Fable — text/coherence** | multi-agent adversarial (144 / 98 / 43 / 182 agents) | prose, data, default-state, envelope, whole-repo coherence | ~195 findings fixed across builds | — | [text audit](https://github.com/fermiexplorer/fermi/blob/main/audit/fable/fable-text-audit.md) |
...
| **Fable — PP arrival adversarial** | 126 agents: finder lenses + 3 distinct-lens skeptics per finding | the PP arrival-optimum note, deep sim, PSI-final reading | miss-shave and flyability-edge corrections applied; PSI-column misread retracted | — | [PP adversarial audit](https://github.com/fermiexplorer/fermi/blob/main/audit/fable/fable-pp-adversarial-audit.md) |
| **Fable — foundations + memo** | 200 + 122 agents (2-of-3 skeptic survival) **plus 4 external frontier models run blind** (GPT-5.6 Sol, Grok 4.5, 2× Gemini) | the shared arrival-model premises, PSI's arrival-epoch memo, the golden fixture | chain verified sound; honest input-systematics band adopted; 2 self-corrections recorded | — | [foundations audit](https://github.com/fermiexplorer/fermi/blob/main/audit/fable/fable-foundations-audit.md) |
