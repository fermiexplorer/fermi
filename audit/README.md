...
| **UI behaviour** | Playwright slider sweep | every control drives the right output (+ the top-level tabs) | **84 / 84 pass** | — | [ui_sliders.py](https://github.com/fermiexplorer/fermi/blob/main/audit/calcs/ui_sliders.py) |
