...
|---|---|---|---|---|---|
| **In-repo suite** | Python, different method than engine | ephemeris → power gate → pumping/thermal → synchrotron → data → docs | **197 / 197 pass** | exact | [calcs/](https://github.com/fermiexplorer/fermi/tree/main/audit/calcs) · [run_audits.py](https://github.com/fermiexplorer/fermi/blob/main/audit/calcs/run_audits.py) |
