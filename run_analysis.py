...
def main() -> None:
    ...
    print(
        ...
        "   pumped variation's OWN ~77,800-yr optimum (7.7 Earth escape + ~24.0 helio + 0.7 tax\n"
        "   + ~0.02 DERIVED 3-D out-of-plane steering -- issue #9: quadratic near beta=0; the same\n"
        "   curve charges 0.51 km/s at the 2.48-deg direct-optimum aim, half the old\n"
        "   v_inf*|sin beta| bolt-on. Direct and pumped are TWO SEPARATE MISSION VARIATIONS with\n"
        "   different optimal arrivals, ~72,800 vs ~77,800 yr -- never mix their optima; the\n"
        "   crossing aim costs the pumped variation only +27 m/s; ~31.1 under the idealised 4x\n"
        "   cap), indicating our closed-form low-thrust budget\n"
    ...
    print(
        ...
        "      two-leg budget ~32.3 km/s from LEO at its own ~77,800-yr optimum (7.7 escape\n"
        "      + ~24.0 helio + 0.7 thermal tax + ~0.02 derived 3-D plane steering; ~31.1 at the\n"
        "      idealised 4x cap).\n"
