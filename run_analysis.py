...
def main() -> None:
    ...
    print(
        ...
        "   OUTWARD-SPIRAL class only. The full SEP two-leg total from LEO is ~32.6 km/s with the\n"
        "   flown thermal schedule (7.6 Earth escape + ~23.7 helio + 0.8 tax + ~0.5 DERIVED 3-D\n"
        "   out-of-plane steering -- issue #9: quadratic near beta=0, half the old v_inf*|sin beta|\n"
        "   bolt-on at the default aim; the pumped fuel optimum becomes a shallow basin at ~77,800 yr\n"
        "   with the 79,250-yr crossing aim only +27 m/s; ~31.4 under the idealised 4x cap),\n"
        "   indicating our closed-form low-thrust budget\n"
    ...
    print(
        ...
        "      two-leg budget ~32.6 km/s from LEO with the anchored optimised schedule (7.6 escape\n"
        "      + ~23.7 helio + 0.8 thermal tax + ~0.5 derived 3-D plane steering; ~31.4 at the\n"
        "      idealised 4x cap).\n"
