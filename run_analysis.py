...
def main() -> None:
    ...
    print(
        ...
        "   pumped variation's 79,766-yr CROSSING DESIGN POINT (79,756 from the 2029 departure) (7.7 Earth escape + ~24.0 helio\n"
        ...
        "   VARIATIONS with different design epochs, ~73,100 yr vs the crossing -- never mix\n"
        "   them. The pumped fuel basin is FLAT: formal bottom ~77,500 yr, ~35 m/s below the\n"
        "   crossing (model-noise scale) -- the geometry-anchored crossing is the fuel/robustness\n"
        "   design epoch; the 73k epoch costs the pumped vehicle +0.25 km/s (~$23k -- the whole\n"
    ...
    print(
        ...
        "      two-leg budget ~32.3 km/s from LEO at its 79,766-yr crossing design point\n"
        "      (7.7 escape + ~24.0 helio + 0.7 thermal tax + ~0 plane steering, in-plane aim;\n"
        "      flat basin bottoms ~77,500 yr, ~35 m/s -- model-noise scale; ~31.1 at the idealised\n"
        "      4x cap).\n"
        ...
        "* Arrival (mission architecture): the 79,766-yr crossing design point (flat basin from\n"
