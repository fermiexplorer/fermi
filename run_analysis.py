...
def main() -> None:
    ...
    print(
        ...
        "   them. The pumped fuel basin is FLAT: formal bottom ~77,800 yr, <30 m/s below the\n"
        "   crossing (model noise) -- the geometry-anchored crossing is the fuel/robustness\n"
        "   design epoch; the 73k epoch costs the pumped vehicle +0.27 km/s (~$25k -- the whole\n"
    ...
    print(
        ...
        "      flat basin bottoms ~77,800 yr, <30 m/s -- model noise; ~31.1 at the idealised\n"
        "      4x cap).\n"
